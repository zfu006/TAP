...
class BaseOptions():
    def initialize(self):
        ...
        parser.add_argument('--ft_clean_vid_dir', type=str, default='/', help='root to specify finetuning datasets')
        parser.add_argument('--test_clean_vid_dir', nargs='+', type=str, default='', help='val img root')
        # parser.add_argument('--test_clean_vid_dir2', type=str, default='', help='val img root')
        parser.add_argument('--test_noisy_vid_dir', type=str, default='')
        parser.add_argument('--ft_dataset', type=str, default='davis', choices=['davis', 'set8'], help='set the dataset')
        parser.add_argument('--test_dataset', type=str, default='davis', choices=['davis', 'set8'], help='set the dataset')
        parser.add_argument('--prepare_datasets', action='store_true', help='set whether to prepare datasets')
        parser.add_argument('--n_frames', type=int, default=5, help='set the number of frames for each video')
        parser.add_argument('--noise_level', type=int, default=30, help='set the noise level')
        parser.add_argument('--img_aug', action='store_true', help='set whether to augment bayer pattern')
        ...
        parser.add_argument('--in_nc', type=int, default=3, help='input channels of the network')  
        parser.add_argument('--out_nc', type=int, default=3, help='output channels of the network') 
